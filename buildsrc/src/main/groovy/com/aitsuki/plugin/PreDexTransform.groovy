...
public class PreDexTransform extends Transform {
    ...
    void transform(Context context, Collection<TransformInput> inputs,
        ...
        def libPath = project.project(':hack').buildDir.absolutePath.concat(java.io.File.separator
                +"intermediates"
        ...
        inputs.each {TransformInput input ->
            ...
            input.jarInputs.each {JarInput jarInput->
                ...
                if(jarPath.endsWith("classes.jar") && jarPath.contains("exploded-aar"+java.io.File.separator+projectName)) {
